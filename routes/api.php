...
Route::middleware('auth:sanctum', 'throttle:api')->group(function () {
    ...
    // RUTAS DE PEDIDOS PARA LE DELIVERY
    Route::get('/pedidosAsignados', [PedidosWebController::class, 'getPedidosAsignados']);
    ...
    Route::put('/delivery/updateUbicacionRider', [PedidosWebController::class, 'pedidoUbicacionRider']);
    Route::get('/delivery/misEntregas', [PedidosWebController::class, 'getMisEntregas']);
    ...
    Route::get('/getPlanilla', [PlanillaController::class, 'getPlanilla']);
    ...
    Route::post('/delivery/promociones', [DeliveryController::class, 'savePromociones']);
    Route::post('/delivery/promociones/update/{id}', [DeliveryController::class, 'updatePromociones']);
    Route::put('/delivery/promociones/{id}', [DeliveryController::class, 'updateEstadoPromociones']);
    Route::delete('/delivery/promociones/{id}', [DeliveryController::class, 'deletePromociones']);
    ...
    Route::delete('delivery/zona-tarifa/{id}', [DeliveryController::class, 'deleteConfiguracionZonas']);

    // CRUD REPARTIDORES DELIVERIE
    Route::get('delivery/repartidores', [DeliveryController::class, 'getRepartidores']);
    Route::put('delivery/repartidores-estado/{id}', [DeliveryController::class, 'updateEstadoRepartidores']);
